...
@Component({
  ...
  templateUrl: './attendence-b-edit.page.html',
  styleUrls: ['./attendence-b-edit.page.scss'],
})
export class AttendenceBEditPage implements OnInit {
...
minTime:any='';
 ...
 start_time:any='';
 start_timenw:any='';
 end_time:any=new Date().toISOString();
